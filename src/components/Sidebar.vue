...
const navItems = [
  ...
  // Evidence viewer (runtime-plane, public endpoints). No capability
  // flag exists — always shown; the lookup itself needs no admin scope.
  { name: 'Evidence', route: '/evidence', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', cap: undefined },
]
