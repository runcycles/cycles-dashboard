...
<template>
  <span class="inline-flex items-center gap-1 font-mono text-xs">
    ...
    <button type="button" @click.stop="revealed = !revealed" :title="revealed ? 'Hide' : 'Reveal'" :aria-label="revealed ? 'Hide credential' : 'Reveal credential'" class="text-gray-600 dark:text-gray-400 hover:text-gray-600 cursor-pointer">
    ...
    <button type="button" @click.stop="copy" :title="copied ? 'Copied!' : 'Copy'" :aria-label="copied ? 'Copied to clipboard' : 'Copy credential to clipboard'" class="text-gray-600 dark:text-gray-400 hover:text-gray-600 cursor-pointer">
