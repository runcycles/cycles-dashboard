...
<template>
  <span class="inline-flex items-center gap-1 font-mono text-xs">
    ...
    <button type="button" @click.stop="revealed = !revealed" :title="revealed ? 'Hide' : 'Reveal'" class="text-gray-400 hover:text-gray-600 cursor-pointer">
    ...
    <button type="button" @click.stop="copy" :title="copied ? 'Copied!' : 'Copy'" class="text-gray-400 hover:text-gray-600 cursor-pointer">
